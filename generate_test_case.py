...
def generate_cases(test_case_dir, case_nums, tensor_size, broadcase_p,large_batch=False):
...
if __name__ == "__main__":
    ...
    large_batch = args.tensor_size == 'large_batch'
    generate_cases(args.out_directory, args.case_nums, size_dict[args.tensor_size],args.broadcast_probality,large_batch=large_batch)
